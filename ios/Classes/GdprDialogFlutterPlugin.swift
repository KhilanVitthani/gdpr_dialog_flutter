...
public class GdprDialogFlutterPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "gdpr_dialog_flutter", binaryMessenger: registrar.messenger())
    let instance = GdprDialogFlutterPlugin()
