package io.flutter.plugin.gdpr_dialog_flutter;
...
/** GdprDialogFlutterPlugin */
public class GdprDialogFlutterPlugin implements FlutterPlugin,ActivityAware, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "gdpr_dialog_flutter");
